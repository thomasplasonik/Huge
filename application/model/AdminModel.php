...
class AdminModel
{
     ...
     * @param $userId
     */
    public static function setAccountSuspensionAndDeletionStatus($suspensionInDays, $softDelete, $groupType, $userId)
    {
        ...
        self::writeDeleteAndSuspensionInfoToDatabase($userId, $suspensionTime, $delete, $groupType);
     ...
     * @return bool
     */
    private static function writeDeleteAndSuspensionInfoToDatabase($userId, $suspensionTime, $delete, $groupType)
    {
